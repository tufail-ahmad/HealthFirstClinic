...
function Footer() {
  ...
  <>
    <footer className={`row ${styles.footer}`}>
      {" "}
      <div className={`col-4 mb-3 ${styles['left-column']}`}>
        <div className={styles.logo}><img src="images/clinicLogo1.png" alt="logo" /></div>
        <p>Your trusted family healthcare clinic providing quality treatment, expreienced doctors, and patient-centred care.</p>
      ...
      <div className={`col-2 mb-3 ${styles['middle-column']}`}>
        {" "}
        <h5>Quick Links</h5>{" "}
        <ul className={`nav flex-column ${styles.list}`}>
          ...
          <li className={`nav-item ${menuActive === "about" ? styles.menuHighlight : null}`}>
            <Link to="/our-doctors" className="nav-link p-0" onClick={() =>  setMenuActive("about")}>
              Our Doctor Team
            </Link>
          </li>{" "}
          <li className="nav-item">
      ...
      <div className={`col-3 mb-3 ${styles['right-column']}`}>
        {" "}
        <h5>Our Services</h5>{" "}
        <ul className={`nav flex-column ${styles.list}`}>
          {" "}
